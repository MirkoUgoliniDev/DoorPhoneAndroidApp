...
import se.lublin.mumla.app.MyApp;
import se.lublin.mumla.callbacks.PostDataCallback;
import se.lublin.mumla.preference.Preferences;
import se.lublin.mumla.screenoff.ScreenOffAdminReceiver;
import se.lublin.mumla.service.MumlaService;
import se.lublin.mumla.util.AboutActivity;
import se.lublin.mumla.util.CommandSubmitter;
import se.lublin.mumla.util.Sounds;
...
public class VideoVLCActivity extends AppCompatActivity implements PostDataCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(se.lublin.mumla.R.layout.activity_video_vlc);
        initUI();
     ...
     *       {@link se.lublin.mumla.service.MumlaService}, che usa il microfono del
     ...
     */
    private void initUI() {
        mMainLayout = (RelativeLayout) findViewById(se.lublin.mumla.R.id.activity_video_vlc);
