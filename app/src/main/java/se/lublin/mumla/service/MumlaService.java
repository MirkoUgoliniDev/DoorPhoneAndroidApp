...
public class MumlaService extends HumlaService implements SharedPreferences.OnSharedPreferenceChangeListener, IMumlaService {
     ...
     * prima di {@link #closeCall()} o disconnessione). Usato da {@link se.lublin.mumla.ui.VideoVLCActivity}
     ...
     *
     * Chiamato da {@link se.lublin.mumla.ui.VideoVLCActivity} quando l'utente preme
     ...
     * se il canale esiste già) come misura di sicurezza nel caso in cui {@link se.lublin.mumla.app.MyApp}
