...
public class Preferences extends PreferenceActivity {
    ...
    public static final String ACTION_PREFS_DOORPI = "se.lublin.mumla.app.PREFS_DOORPI";
    ...
    private static void configureDoorPiPreferences(final Context context, PreferenceScreen screen) {
        ...
        adminPref.setOnPreferenceClickListener(pref -> {
            ...
            String component = context.getPackageName()
                    + "/se.lublin.mumla.screenoff.ScreenOffAdminReceiver";
                ...
                new Handler(Looper.getMainLooper()).post(() -> {
                    if (ok) {
                        ...
                        Toast.makeText(context,
                                ...
                                "Metodo 2 — ADB da PC:\n" +
                                "  adb shell dpm set-active-admin " + pkg + "/se.lublin.mumla.screenoff.ScreenOffAdminReceiver",
