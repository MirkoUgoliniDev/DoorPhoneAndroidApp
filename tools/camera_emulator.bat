...
:: ============================================================
:: camera_emulator.bat
:: Imposta l'endpoint della camera sull'emulatore
:: per usare il proxy locale invece della camera reale.
::
:: Eseguire DOPO aver avviato proxy_start.bat
:: ============================================================
...
echo.
echo  *** CAMERA: modalita' EMULATORE ***
